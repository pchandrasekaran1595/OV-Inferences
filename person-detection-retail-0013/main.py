...
def main():
    ...
    if re.match(r"^image$", args.mode, re.IGNORECASE):
        ...
        for box in boxes: cv2.rectangle(disp_image, (box[0], box[1]), (box[2], box[3]), (0, 255, 0), 1)         
        ...
        while True:
            ...
            if ret:
                ...
                for box in boxes: cv2.rectangle(disp_frame, (box[0], box[1]), (box[2], box[3]), (0, 255, 0), 1)         
